...
public class InformerClientHandler implements JobHandler {
    private static final String MESSAGE_NAME = "msg_demandeenvoye";
    ...
    public void handle(JobClient client, ActivatedJob job) throws Exception {
        ...
        try (final ZeebeClient travelAgencyClient = ZeebeClient.newClientBuilder()
            ...
            System.out.println(travelRequestId2 + " message d'information du client  envoyé");
